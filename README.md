...
* `useExistingNumber` _(boolean)_: Set it to true if you want to use an existing Twilio Number for testing. Setting this parameter to true requires you to set the TWILIO_PHONE_SID environment variable.
